...
## Environments
- Preview: https://main--aem-universal-editor--bersha.aem.page/
- Live: https://main--aem-universal-editor--bersha.aem.live/
...
1. Open the `aem-universal-editor` directory in your favorite IDE and start coding :)
